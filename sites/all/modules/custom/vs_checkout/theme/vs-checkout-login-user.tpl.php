      ...
      <div>
        <div class="signin">
          ...
          <div class="signin-body">
            ...
            <div class="ui-alert vs-signin-error-msg" <?php is_null($err)? print 'style="display: none;"': NULL; ?>>
                  <p>Неверное имя пользователя или пароль. Проверьте правильность введенных данных.</p>
                </div>
                <?php print drupal_render($form['login_pane']['name']); ?>
                <?php print drupal_render($form['login_pane']['pass']); ?>
<!--              <div class="password-help">
              ...
              <!--<div class="element-hidden vs-checkout-login-submit">-->
                <?php // print drupal_render($form['login_pane']['actions']['submit']); ?>
              <!--</div>-->
          </div>
        </div>
        ...
        <div class="checkout-option">
          ...
          <div class="panel-footer grp"> 
            ...
            <div class="element-hidden vs-checkout-continue-guest-submit">
              <?php print drupal_render($form['login_pane']['actions']['continue_guest']); ?>
            </div>
          </div>
